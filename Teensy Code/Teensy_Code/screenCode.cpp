...
void printCommonBackground()
{
  ...
  if(previousHVSOC != HVSOC || !previouslyon || previousdriveMode == 11 || previousdriveMode == 9)
  {
    updateScreenSOC();
  }
  ...
  tft.setTextSize(2);
  tft.println("SOC");
  if(previousmaxCellTemp != maxCellTemp || !previouslyon || previousdriveMode == 11 || previousdriveMode == 9)
  {
...
{
  if(previousTitle != title || !previouslyon || previousdriveMode == 11 || previousdriveMode == 9 || previouslyStartActive != startActive)
  {
    printScreenTitle(title, number);
    previousTitle = title;
  }
  if(previousdriveMode != driveMode || !previouslyon || previousdriveMode == 11 || previousdriveMode == 9 || previouslyStartActive != startActive)
  {
    printScreenNumber();
